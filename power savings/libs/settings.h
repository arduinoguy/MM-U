...
int keyCodes[NUM_INPUTS] = {0x1A,0x04,0x16,0x07,0x09,0x0A,0x05,0x60,0x07};
  
 
 /* 0x52,      // up arrow pad
  0x51,    // down arrow pad
  0x50,    // left arrow pad
  0x4F,   // right arrow pad
  0x2C,*/   // space button pad
...
// NOISE CANCELLATION /////
///////////////////////////
#define SWITCH_THRESHOLD_OFFSET_PERC  20    // number between 1 and 49
